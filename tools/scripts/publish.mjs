...
try {
    console.log(`\x1b[36mPublishing @overlap/rte@${cleanVersion} with tag "${tag}"...\x1b[0m`);
    execSync(`npm publish --access public --tag ${tag}`, {
        stdio: 'inherit',
    });
    console.log(`\x1b[32m✓\x1b[0m Successfully published @overlap/rte@${cleanVersion} with tag "${tag}"`);
} catch (e) {
    console.error(
